 ...
 */
	private Project2f.Apparel.Condition Condition;
/**
 ...
 */
	public Project2f.Apparel.Condition getCondition() {
		return Condition;
	}
/**
 * Setter method for the condition of the item	
 * @param newCondition Will take in a conditon from the user
 */
